...
os.system("clear")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Jangan Lupa Subscribe Channel Sidhanie")
time.sleep(3)
os.system("xdg-open https://youtube.com/@sidhanie?sub_confirmation=1")
...
{abu}-----------------------------------------
{putih}[{biru}•{putih}] {biru}Author {putih}   : Sidhanie
{putih}[{biru}•{putih}] {abu}GitHub {putih}   : Sidhanie
{putih}[{biru}•{putih}] {merah}You{putih}Tube {putih}  : @Sidhanie
{putih}[{biru}•{putih}] {ungu}Instagram {putih}: @appsidhanieofficial
